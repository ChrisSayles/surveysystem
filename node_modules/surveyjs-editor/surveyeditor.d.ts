/*Type definitions for Surveyjs Builder(Editor) JavaScript library v1.0.10
...
export declare class SurveyPagesEditor {
    ...
    onCopyPageCallback: SurveyPageParamCallback;
    ...
    showQuestionEditor(data: any): void;
    deletePageClick(pageItem: any): void;
    copyPageClick(pageItem: any): void;
    removePage(page: Survey.Page): void;
    getSelectedClass(): "icon-gear-active" | "icon-gear";
...
export declare class SurveyEditor implements ISurveyObjectEditorOptions {
        ...
        protected setModified(options?: any): void;
        /**
